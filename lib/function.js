...
export default { getBuffer, h2k, generateMessageID, getGroupAdmins, randomBytes, getRandom, parseRegex, clockString, parseSeconds, randomSelect, randomPass, randomUID, randomPh, isString, isNotString, isNumber, isNotNumber, wame, find, isEven, isOdd, getAge, parseRegex, genHTML, kerang: new Kerang(), hk, chck, upperFirst }
