...
`.trim(),
    me + ' ~' + conn.user.name,
    dateFormat("YYYY-MM-DD, hh:mm:ss", (m.messageTimestamp ? new Date(1000 * (m.messageTimestamp.low || m.messageTimestamp)) : new Date))/*.toTimeString()*/,
